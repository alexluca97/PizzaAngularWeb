    ...
    this.products = [
      {
        ...
        description: 'Pizza quattro stagioni (four seasons pizza) is a variety of pizza in Italian cuisine that is prepared in four sections with diverse ingredients, with each section representing one season ofthe year. It is a very popular pizza in Italy,[1] and has been described as a "classic", "famous"and "renowned" Italian pizza.',
        ingredients: ['blat', 'ulei de măsline', 'salsa di pomodoro', 'mozzarella', 'salam', 'şuncă', 'ciuperci', 'măsline verzi', 'şuncă presată'],
        type: [['mica', '25dm', 23.15], ['medie', '36dm', 28.00], ['mare', '42dm', 42.00]]
      },
      {
        id: 2,
